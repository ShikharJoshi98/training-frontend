...
const DownloadBrochure = ({ onClose }: ModalProps) => {
    ...
    return (
        <div className="bg-black/50 z-60 fixed inset-0 flex items-center justify-center p-2">
            <div className="bg-white overflow-x-hidden max-h-[90vh] max-w-[90vw] md:max-w-[50vw] lg:max-w-[45vw] overflow-y-auto flex flex-col w-full rounded-xl p-6 md:p-10 shadow-lg">
                ...
                <h1 className='text-2xl urbanist_bold text-center'>Download Brochure</h1>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-5 mt-5'>
                    ...
                    <button className='bg-[#525fe1] urbanist_bold text-lg py-3 px-8 cursor-pointer hover:bg-[#4753dc] duration-300 rounded-md text-white w-fit mx-auto'>Download</button>
                </form>
            </div>
        </div>
    )
